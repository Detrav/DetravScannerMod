...
public class ModelTunnelBore extends ModelBase
{
    ...
    private short[] baseColors;
    private short[] headColors;

    public ModelTunnelBore()
    {
        baseColors = new short[]{0xff,0xff,0xff,0xff };
        headColors = new short[4];
    ...
    public void render(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        GL11.glColor4f(baseColors[0]/255F, baseColors[1]/255F, baseColors[2]/255F, 1F);
        base.render(f5);
        rear.render(f5);
        //here old head
        boreFrame.render(f5);
        ...
        stack.render(f5);
        if(renderBoreHead) {
            GL11.glColor4f(headColors[0]/255F, headColors[1]/255F, headColors[2]/255F, 1F);
            boreHead.render(f5);
        }
    }
    ...
    public void setColors(short[] aBaseColors, short[] aHeadColors)
    {
        if(aBaseColors!=null)
            baseColors = aBaseColors;
        if(aHeadColors!=null)
            headColors = aHeadColors;
    }

    public void setColors(short[] aBaseColors)
    {
        setColors(aBaseColors,null);
    }
}